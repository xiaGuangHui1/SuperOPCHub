  ...
  const [posts, setPosts] = useState<Post[]>([
    {
      ...
      user: {
        name: "设计师小王",
        avatar: "https://i.pravatar.cc/300?u=designer-wang",
        isFollowed: false,
      },
      content: "刚完成了一个企业官网设计项目，客户非常满意！分享一下设计过程中的关键思考：1. 色彩搭配要符合品牌调性 2. 布局要突出核心价值 3. 交互要简洁流畅 #UI 设计 #官网设计",
      images: [
        "https://picsum.photos/seed/ui-mockup/800/600",
        "https://picsum.photos/seed/app-design/800/600",
        "https://picsum.photos/seed/web-layout/800/600",
      ],
      likes: 128,
      comments: 23,
      shares: 15,
    ...
    },
    {
      ...
      user: {
        name: "开发者老李",
        avatar: "https://i.pravatar.cc/300?u=dev-li",
        isFollowed: true,
      },
      content: "分享一个 React 性能优化技巧：使用 useMemo 和 useCallback 避免不必要的重新渲染。代码已开源，欢迎 star！🚀",
      video: "https://picsum.photos/seed/dev-workspace/800/600",
      likes: 256,
      comments: 45,
      shares: 38,
      isLiked: true,
    ...
    },
    {
      ...
      user: {
        name: "产品经理小张",
        avatar: "https://i.pravatar.cc/300?u=pm-zhang",
        isFollowed: false,
      },
    ...
    },
    {
      ...
      user: {
        name: "创意设计师小陈",
        avatar: "https://i.pravatar.cc/300?u=designer-chen",
        isFollowed: false,
      },
      content: "最新的品牌 VI 设计作品，采用了大胆的渐变色彩和几何图形，传达现代科技感。大家觉得怎么样？",
      images: [
        "https://picsum.photos/seed/brand-identity/800/600",
        "https://picsum.photos/seed/logo-design/800/600",
      ],
      likes: 312,
      comments: 56,
      shares: 42,
